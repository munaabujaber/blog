  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full px-4 md:w-[var(--timeline-width)] md:px-0">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] md:gap-x-[var(--timeline-center-gap)]">
          <div className="flex flex-col gap-8 md:gap-[var(--timeline-column-gap)]">
            {leftPosts.map((post) => (
              <div
